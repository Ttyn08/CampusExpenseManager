...
public final class ActivitySignupBinding implements ViewBinding {
  ...
  private ActivitySignupBinding(@NonNull ScrollView rootView, @NonNull TextView loginRedirectText,
      @NonNull ScrollView main, @NonNull EditText signupAge, @NonNull Button signupButton,
      @NonNull EditText signupConfirm, @NonNull EditText signupEmail, @NonNull EditText signupName,
      @NonNull EditText signupPassword, @NonNull EditText signupPhone) {
  ...
  public static ActivitySignupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySignupBinding((ScrollView) rootView, loginRedirectText, main, signupAge,
          signupButton, signupConfirm, signupEmail, signupName, signupPassword, signupPhone);
    }
